...
def build_efficientnet_unet(input_shape):
    ...
    """ Pre-trained Encoder """
    encoder = tf.keras.applications.EfficientNetB0(include_top=False, weights="imagenet", input_tensor=inputs)
    ...
    model = tf.keras.models.Model(inputs, outputs, name="EfficientNetB0_UNET")
    return model